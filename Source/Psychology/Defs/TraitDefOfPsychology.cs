...
{
    [DefOf]
    public static class TraitDefOfPsychology
    {
        public static TraitDef Prude;
        public static TraitDef Insomniac;
        public static TraitDef BleedingHeart;
        public static TraitDef Gourmet;
        public static TraitDef Lecher;
        public static TraitDef Codependent;
        public static TraitDef Outdoorsy;
        public static TraitDef Pluviophile;
        public static TraitDef Photosensitive;
        public static TraitDef Socialite;
        public static TraitDef Desensitized;
        public static TraitDef HeavySleeper;
