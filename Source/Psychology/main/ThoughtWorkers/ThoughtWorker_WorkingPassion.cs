...
namespace Psychology
{
    public class ThoughtWorker_WorkingPassion : ThoughtWorker
    {
        protected override ThoughtState CurrentStateInternal(Pawn p)
        {
            ...
            {
                LocalTargetInfo info = p.jobs.curJob.GetTarget(TargetIndex.A);
                if (info == null)
                    return (ThoughtState)false;
                ...
                if (billGiver.BillStack == null)
                    return (ThoughtState)false;
                if (billGiver.BillStack.FirstShouldDoNow == null)
                    return (ThoughtState)false;
                if (billGiver.BillStack.FirstShouldDoNow.recipe == null)
                    return (ThoughtState)false;
