...
namespace Psychology
{
    public class Hediff_Mayor : Hediff
    {
        ...
        {
            base.Tick();
            if (this.pawn.Dead || !PsychologyBase.ActivateElections() || Find.WorldObjects.ObjectsAt(worldTileElectedOn).OfType<FactionBase>().First().Map.lordManager.lords.Find(l => l.LordJob is LordJob_Joinable_Election) != null)
            {
