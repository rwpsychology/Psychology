...
{
    public class MapCondition_Election : MapCondition
    {
        ...
        {
            base.ExposeData();
            Scribe_Collections.LookList(ref this.candidates, "candidates", LookMode.Deep);
        }
        ...
        public override void End()
        {
            ...
            Find.LetterStack.ReceiveLetter("LetterLabelElectionHeld".Translate(baseName), "LetterElectionHeld".Translate(baseName), LetterType.Good, new TargetInfo(intVec, organizer.Map, false), null);
        }
